 ...
 */
public class Test_player_it implements Serializable
{
  /**
  ...
  private Boolean tryTagging(BailiffInterface currentBailiff) {
  ...
  public static void main (String [] argv)
    ...
    Test_player_it dx = new Test_player_it();
